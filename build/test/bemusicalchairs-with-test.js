...
var BemusicalChairs, SomeClass, Tudor, tudor, x, xx,
...
tudor.add([
  "01 BemusicalChairs Constructor", tudor.is, "The class and instance are expected types", function() {
    return [new BemusicalChairs];
  }, "The BemusicalChairs class is a function", oo.F, function() {
    return BemusicalChairs;
  }, "`new` returns an object", oo.O, function(bemusicalchairs) {
    return bemusicalchairs;
  }, tudor.equal, "`BemusicalChairs::C` is 'BemusicalChairs'", 'BemusicalChairs', function(bemusicalchairs) {
    return bemusicalchairs.C;
  }, "`BemusicalChairs::toString()` is '[object BemusicalChairs]'", '[object BemusicalChairs]', function(bemusicalchairs) {
    return bemusicalchairs + '';
  }, "Instance properties as expected", tudor.equal, "`BemusicalChairs::x` is the number `123`", 123, function(bemusicalchairs) {
    return bemusicalchairs.x;
  }, "`BemusicalChairs::_x` is private, and is null", null, function(bemusicalchairs) {
    return bemusicalchairs[oo._]._x;
  }
]);

if (oo.ROBUSTABLE) {
  tudor.add([
    "91 Robust BemusicalChairs Constructor (for modern UAs)", tudor.is, "Class members are immutable in modern UAs", function() {
      return [new BemusicalChairs];
    }, "Cannot add a property to the BemusicalChairs class", oo.U, function() {
      BemusicalChairs.nope = 123;
      return BemusicalChairs.nope;
    }, "Cannot add a property to the BemusicalChairs class’s prototype object", oo.U, function(bemusicalchairs) {
      BemusicalChairs.prototype.nope = 456;
      return bemusicalchairs.nope;
    }, tudor.equal, "`BemusicalChairs::C` is a constant", 'BemusicalChairs', function(bemusicalchairs) {
      bemusicalchairs.C = 'changed!';
      return bemusicalchairs.C;
    }
  ]);
}
